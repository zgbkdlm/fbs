...
from fbs.samplers import bootstrap_filter_aug as bootstrap_filter
...
parser.add_argument('--obs_var', type=float, default=10, help='The observation noise variance.')
